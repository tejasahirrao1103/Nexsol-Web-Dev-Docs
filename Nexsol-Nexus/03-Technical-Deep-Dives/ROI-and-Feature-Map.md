...
```mermaid
graph TD
    Start[SME Current State] --> Q1{Manual Support?}
    Q1 -- Yes --> AI_Bot[AI Support Integration]
    AI_Bot --> ROI1[40% Support Cost Reduction]
    
    Start --> Q2{Low Sales?}
    Q2 -- Yes --> AI_Sales[AI Sales Qualifying Loop]
    AI_Sales --> ROI2[2x Lead Conversion]
    
    Start --> Q3{Slow Loading?}
    Q3 -- Yes --> Next_Mig[Next.js Performance Engine]
    Next_Mig --> ROI3[SEO Rank Boost + 30% Traffic]
    
    style Start fill:#1e293b,color:#fff
    style ROI1 fill:#22c55e,color:#fff
    style ROI2 fill:#22c55e,color:#fff
    style ROI3 fill:#22c55e,color:#fff
```
